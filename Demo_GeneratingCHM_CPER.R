...
byFileAOP("DP3.30015.001", site="CPER", year="2013", check.size=T);
...
for (time in 2013:2013) 
{
  for (i in cd1)
  {
    for (j in cd2)
    {
      inputpath=sprintf("DP3.30015.001/%i/FullSite/D10/%i_CPER_1/L3/DiscreteLidar/CanopyHeightModelGtif/%i_CPER_1_%i_%i_pit_free_CHM.tif",time,time,time,i,j);
