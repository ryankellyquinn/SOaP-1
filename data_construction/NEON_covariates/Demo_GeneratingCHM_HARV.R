...
byFileAOP("DP3.30015.001", site="HARV", year="2014", check.size=T);
...
for (time in 2014:2014) 
{
  for (i in cd1)
  {
    for (j in cd2)
    {
      inputpath=sprintf("DP3.30015.001/%i/FullSite/D01/%i_HARV_2/L3/DiscreteLidar/CanopyHeightModelGtif/%i_HARV_2_%i_%i_CHM.tif",time,time,time,i,j);
